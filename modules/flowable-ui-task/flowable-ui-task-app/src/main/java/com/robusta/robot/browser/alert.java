...
public class alert implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
    	...
    	System.out.println("Web Application Alert Parameters");
        ...
        HttpPost request = new HttpPost( ClientConstants.STENCIL_TASK_WEBHOST_URL + "alert");
...
//	            }
	        	...
	        	throw new BpmnError("WA-0002", "Error switching page "+browserId);
			}
