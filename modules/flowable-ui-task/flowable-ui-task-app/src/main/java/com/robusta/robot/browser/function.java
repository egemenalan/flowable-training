...
public class function implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
    	...
    	System.out.println("Web Application Function Parameters");
        ...
        HttpPost request = new HttpPost( ClientConstants.STENCIL_TASK_WEBHOST_URL + "functions");
...
//	            }
	        	...
	        	throw new BpmnError("WA-0002", "Error on Function "+browserId);
			}
