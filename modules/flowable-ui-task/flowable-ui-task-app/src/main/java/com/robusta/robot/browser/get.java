...
public class get implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
    	...
    	System.out.println("Web Application Get Parameters");
        ...
        HttpPost request = new HttpPost( ClientConstants.STENCIL_TASK_WEBHOST_URL + "get");
