...
public class capture implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
    	...
    	System.out.println("Web Application Capture Parameters");
        ...
        HttpPost request = new HttpPost( ClientConstants.STENCIL_TASK_WEBHOST_URL + "capture");
...
//	            }
	        	...
	        	throw new BpmnError("WA-0002", "Error on capture "+browserId);
			}
