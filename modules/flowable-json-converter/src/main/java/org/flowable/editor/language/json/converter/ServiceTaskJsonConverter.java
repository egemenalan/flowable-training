...
public class ServiceTaskJsonConverter extends BaseBpmnJsonConverter implements DecisionTableKeyAwareConverter {
    ...
    public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
    	System.out.println("ServiceTaskJsonConverter-fillJsonTypes");
        convertersToBpmnMap.put(STENCIL_TASK_SERVICE, ServiceTaskJsonConverter.class);
    }

    public static void fillBpmnTypes(Map<Class<? extends BaseElement>, Class<? extends BaseBpmnJsonConverter>> convertersToJsonMap) {
    	System.out.println("ServiceTaskJsonConverter-fillBpmnTypes");
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        ...
        RobustaServiceTaskJsonConverter robustaServiceTaskJsonConverter = new RobustaServiceTaskJsonConverter();
        ...
        } else if ("custom".equalsIgnoreCase(serviceTask.getType())) {
        	robustaServiceTaskJsonConverter.robustaConvertElementToJson(propertiesNode, baseElement, serviceTask);
...
//            setPropertyFieldValue(PROPERTY_BROWSERTASK_RET_RESULT_VARIABLE, "resultVariable", serviceTask, propertiesNode);
