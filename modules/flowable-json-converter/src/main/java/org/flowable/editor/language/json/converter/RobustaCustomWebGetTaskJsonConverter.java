 ...
 * @author Egemen ALAN
 */
public class RobustaCustomWebGetTaskJsonConverter extends BaseBpmnJsonConverter {
    ...
    public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
    	...
    	//Mouse
    	  convertersToBpmnMap.put(STENCIL_TASK_WEBGET, RobustaCustomWebGetTaskJsonConverter.class);
    }
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap) {
        ...
        //Mouse
        task.setType("customWebGet");
        addField("browserId", PROPERTY_BROWSERTASK_NAME, elementNode, task);
        addField("field", PROPERTY_BROWSERTASK_FIELD, elementNode, task);
        addField("attribute", PROPERTY_BROWSERTASK_ATTR_NAME, elementNode, task);
    	
        task.setImplementationType(ImplementationType.IMPLEMENTATION_TYPE_CLASS);
        //Mouse
        task.setImplementation("com.robusta.robot.browser.get");
